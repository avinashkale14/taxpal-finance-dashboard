    ...
    const handleGenerate = async (e) => {
        ...
        try {
            ...
            if (res.success) {
                ...
                window.open(`http://https://taxpal-finance-dashboard.onrender.com${res.data.file_path}`, '_blank');
            }
        } catch (error) {
                                                    ...
                                                    return (
                                                        <tr key={report._id} className="bg-white border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                                                            ...
                                                            <td className="px-6 py-4 text-right">
                                                                <a
                                                                    href={`http://https://taxpal-finance-dashboard.onrender.com${report.file_path}`}
                                                                    target="_blank"
                                                                    rel="noreferrer"
